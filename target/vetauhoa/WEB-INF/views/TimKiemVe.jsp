            ...
            <div class="col-md-6">
                <div class="login-box bg-white box-shadow border-radius-10">
                    <div class="login-title">
                        <h2 class="text-center text-primary">Thông tin vé đặt</h2>
                    </div>
                    <h6 class="mb-20">Nhập thông tin vé đặt</h6>
                    <h6 class="mb-20" style="color: red">${message}</h6>
                    <form action="${pageContext.request.contextPath}/phieu-dat" method="post">
                        <div class="input-group custom">
                            <input type="text" id="CCCD" name="CCCD" class="form-conttrol form-control-lg" placeholder="Số CMND/Mã CCCD">
                        ...
                        <div class="input-group custom">
                            <input type="text" id="veid" name="veid" class="form-conttrol form-control-lg" placeholder="Mã số vé">
                            <div class="input-group-append custom">
                            <span class="input-group-text"><i class="icon-copy fa fa-ticket" aria-hidden="true"></i></span>
                        </div>
                        </div>
                        <div class="row align-items-center">
                            <div class="col-5">

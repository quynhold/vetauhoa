            ...
            <div class="pd-20 card-box mb-30">
                <div class="row et-main-content col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                    <div class="col-md-8 form-group">
                        <h4 class="mb-3">Thêm Hành Khách</h4>
                        <form action="${pageContext.request.contextPath}/admin/hanh-khach/add" class="needs-validation" method="post">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="ho">Họ</label>
                                    <input name="ho" type="text" class="form-control" id="ho" placeholder="" value=""
                                           required="">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="ten" type="text" class="form-control" id="ten" placeholder="" value=""
                                           required="">
                                    <div class="invalid-feedback">
                                        Yêu cầu nhập tên.
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input name="cccd" type="text" class="form-control" id="cccd" placeholder="CCCD"
                                           required="">
                                    <div class="invalid-feedback" style="width: 100%;">
                                        Yêu cầu nhập CCCD.
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="sdt" type="text" class="form-control" id="sdt" placeholder="" required="">
                                <div class="invalid-feedback">

        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="profile-info">
                    ...
                    <ul>
                        <li>
                            <label style="color: blue">Tên hành khách:</label><label class="d-inline-block"> ${hanhKhach.ho} ${hanhKhach.ten}</label>
                        </li>
                        <li>
                            <label style="color: blue">Ngày sinh:</label><label class="d-inline-block"> ${hanhKhach.ngaySinh}</label>
                        </li>
                        <li>
                            <label style="color: blue">Giới tính:</label><label class="d-inline-block"> ${hanhKhach.gioiTinh}</label>
                        </li>
                        <li>
                            <label style="color: blue">Căn cước công dân:</label><label class="d-inline-block"> ${hanhKhach.cccd}</label>
                        </li>
                        <li>
                            <label style="color: blue">Số điện thoại:</label><label class="d-inline-block"> ${hanhKhach.sdt}</label>
                        </li>
                        <li>
                            <label style="color: blue">Địa chỉ:</label><label class="d-inline-block">${hanhKhach.diaChi}</label>
                        </li>
                        <li>
                            <label style="color: blue">Email:</label><label class="d-inline-block">${hanhKhach.email}</label>
                        </li>
                    </ul>
                    <a href="${pageContext.request.contextPath}/user/edit-profile" class="btn-shadow btn btn-primary">Chỉnh sửa</a>
                </div>
            </div>
        </div>

      ...
      <div class="pd-20 card-box mb-30">
        <div class="row et-main-content col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          <div class="col-md-8 form-group">
            ...
            <form action="${pageContext.request.contextPath}/admin/nhan-vien/add" class="needs-validation" method="post">
              <div class="row">
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input name="ngaySinh" type="date" class="form-control" id="ngaySinh"

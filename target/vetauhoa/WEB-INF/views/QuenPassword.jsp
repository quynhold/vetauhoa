    ...
    <div class="row align-items-center">
      ...
      <div class="col-md-6">
        <div class="login-box bg-white box-shadow border-radius-10">
          ...
          <h6 class="mb-20">Nhập thông tin tài khoản</h6>
          <h6 class="mb-20" style="color: red">${message}</h6>
          <form action="${pageContext.request.contextPath}/quen-password" method="post">
            <div class="input-group custom">
              <input type="text" id="username" name="username" class="form-conttrol form-control-lg" placeholder="Tên tài khoản">
              <div class="input-group-append custom">
                <span class="input-group-text"><i class="fa fa-info-circle" aria-hidden="true"></i></span>
              </div>
            </div>
            <h6 class="mb-20">Hoặc</h6>
            <div class="input-group custom">
              <input type="email" id="email" name="email" class="form-conttrol form-control-lg" placeholder="Email">
              <div class="input-group-append custom">
                <span class="input-group-text"><i class="icon-copy fa fa-mail-forward" aria-hidden="true"></i></span>
              </div>
            </div>
            <div class="row align-items-center">
              <div class="col-5">
              ...
              <div class="col-5">
                <div class="input-group mb-0">
                  ...
                  -->
                  <button class="btn btn-primary btn-lg btn-block" type="submit">Gửi mail</button>
                </div>
              </div>
            </div>
          </form>

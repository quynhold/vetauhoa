        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-20">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Danh sách hành khách</h4>
                    </div>
                    <form class="d-inline-block float-right" action="${pageContext.request.contextPath}/admin/hanh-khach/add">
...
<%--                        </form>--%>
                    ...
                    <thead>
                    <tr>
                        <th class="text-center"  scope="col">Mã hành khách</th>
                    ...
                    <tbody>
                    <c:forEach var="hanhKhach" items="${hanhKhachList}">
                            <tr class="table-active align-middle text-truncate mb-0 table table-borderless table-hover">
                                <td class="text-center" scope="col">${hanhKhach.maHanhKhach}</td>
                                <td class="text-center" scope="col">${hanhKhach.ho}</td>
                                <td class="text-center" scope="col">${hanhKhach.ten}</td>
                                <td class="text-center" scope="col">${hanhKhach.gioiTinh}</td>
                                <td class="text-center" scope="col">${hanhKhach.ngaySinh.toString()}</td>
                                <td class="text-center" scope="col">${hanhKhach.sdt}</td>
                                <td class="text-center" scope="col">${hanhKhach.email}</td>
                                <td class="text-center">
                                    <div class="btn-group-sm btn-group">
                                        <form>
                                        <button type="submit" formaction="${pageContext.request.contextPath}/admin/hanh-khach/${hanhKhach.maHanhKhach}/edit" class="btn-shadow btn btn-primary">Sửa</button>
                                        </form>
                                        <form>
                                         <button type="submit" formaction="${pageContext.request.contextPath}/admin/hanh-khach/${hanhKhach.maHanhKhach}/delete" class="btn-shadow btn btn-primary">Xóa</button>
                                        </form>
                                    </div>
                                </td>
                            </tr

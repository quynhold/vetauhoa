        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-20">
                    ...
                    <form class="d-inline-block float-right" action="${pageContext.request.contextPath}/admin/nhan-vien/add">
...
<%--                        </form>--%>
                    ...
                    <c:forEach var="nhanVien" items="${nhanVienList}">
                            <tr class="table-active align-middle text-truncate mb-0 table table-borderless table-hover">
                                <td class="text-center" scope="col">${nhanVien.maNhanVien}</td>
                                <td class="text-center" scope="col">${nhanVien.ho}</td>
                                <td class="text-center" scope="col">${nhanVien.ten}</td>
                                <td class="text-center" scope="col">${nhanVien.ngaySinh.toString()}</td>
                                <td class="text-center">
                                    <div class="btn-group-sm btn-group">
                                        <form>
                                            <button type="submit" formaction="${pageContext.request.contextPath}/admin/nhan-vien/${nhanVien.maNhanVien}/edit" class="btn-shadow btn btn-primary">Sửa</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>

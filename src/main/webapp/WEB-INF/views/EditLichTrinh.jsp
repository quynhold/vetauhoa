            ...
            <div class="pd-20 card-box mb-30">
                <div class="row et-main-content col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                    <div class="col-md-8 form-group">
                        <h4 class="mb-3">Chỉnh sửa lịch trình</h4>
                        <form action="${pageContext.request.contextPath}/admin/lich-trinh/${maLichTrinh}/edit" class="needs-validation" method="post">
                            <datalist id="gaList">
                            ...
                            <datalist id="tauList">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input name="maGaXuatPhat" type="text" list="gaList" class="form-control" id="gaXuatPhat"
                                               placeholder="" value="${lichTrinh.gaByMaGaXuatPhat.maGa}" required="">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input name="maGaCuoi" type="text" list="gaList" class="form-control" id="gaCuoi"
                                               placeholder="" value="${lichTrinh.gaByMaGaCuoi.maGa}" required="">
                                        <div class="invalid-feedback">
                                            Yêu cầu chọn ga.
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input name="gioXuatPhat" type="time" class="form-control" id="gioXuatPhat"
                                               placeholder="" value="${lichTrinh.thoiGianXuatPhat.toLocalDateTime().toLocalTime()}" required="">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input name="ngayXuatPhat" type="date" class="form-control" id="ngayXuatPhat"
                                               placeholder="" required="" value="${lichTrinh.thoiGianXuatPhat.toLocalDateTime().toLocalDate()}">
                                        <div class="invalid-feedback" style="width: 100%;">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="maTau" type="text" list="tauList" class="form-control" id="maTau"
                                           placeholder="" value="${lichTrinh.tauByMaTau.bienSo}">
                                    <div class="invalid-feedback">
                                        Vui lòng chọn tàu.
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="giaMoCua" type="number" class="form-control" id="giaMoCua"
                                           placeholder="" required="" value="${lichTrinh.giaMoCua.intValue()}">
                                    <div class="invalid-feedback">
                                        Vui lòng nhập giá.
                                    </div>
                                </div>

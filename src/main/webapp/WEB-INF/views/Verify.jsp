    ...
    <div class="row align-items-center">
      ...
      <div class="col-md-6">
        <div class="login-box bg-white box-shadow border-radius-10">
          ...
          <form action="${pageContext.request.contextPath}/${username}/confirm-verify" method="get">
            ...
            <div class="row align-items-center">
              <div class="col-5">
                <div class="input-group mb-0">
                  <button class="btn btn-outline-primary btn-lg btn-block" type="reset">Gửi lại</button>
                </div>
              </div>
              <div class="col-2">

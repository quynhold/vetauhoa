    ...
    <div class="min-height-200px">
      <div class="row">
        <div class="pd-20 card-box mb-30">
          <h3>Mã số tàu: ${toaList.get(0).tauByMaTau.bienSo}</h3>
          <div class="container et-train-list train-group">
            <c:forEach var="toa" items="${toaList}">
              <div class="card text-white bg-info mb-3 d-inline-block" style="max-width: 20rem;">
                <form action="${maLichTrinh}/${toa.maToa}/chon-cho">
                  <div class="card-header">${toa.maToa}</div>
                  <div class="card-body">
                    <h4 class="card-title" style="color: white">Loaị toa:${toa.loaiCho}</h4>
                    <button type="submit"><p style="color: #0a53be">Chọn toa</p></button>
                  </div>
                </form>
              </div>
            </c:forEach>

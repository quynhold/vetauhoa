        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-20">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Danh sách lịch trình</h4>
                    </div>
                    <form class="d-inline-block float-right" action="${pageContext.request.contextPath}/admin/lich-trinh/add" method="get">
...
<%--                        </form>--%>
                    ...
                    <thead>
                    <tr>
                        <th class="text-center" scope="col">Mã lịch trình</th>
                        <th class="text-center" scope="col">Mã tàu</th>
                        <th class="text-center"  scope="col">Ga xuất phát</th>
                        <th class="text-center" scope="col">Ga Cuối</th>
                        <th class="text-center" scope="col">Thời gian xuất phát</th>
                        <th class="text-center" scope="col">Giá mở cửa</th>
                        <th scope="col"></th>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach var="lichTrinh" items="${lichTrinhList}">
                        <tr class="table-active align-middle text-truncate mb-0 table table-borderless table-hover">
                            <td class="text-center" scope="col">${lichTrinh.maLichTrinh}</td>
                            <td class="text-center" scope="col">${lichTrinh.tauByMaTau.bienSo}</td>
                            <td class="text-center" scope="col">${lichTrinh.gaByMaGaXuatPhat.tenGa}</td>
                            <td class="text-center" scope="col">${lichTrinh.gaByMaGaCuoi.tenGa}</td>
                            <td class="text-center" scope="col">${lichTrinh.thoiGianXuatPhat}</td>
                            <td class="text-center" scope="col">${lichTrinh.giaMoCua} VND</td>
                            <td class="text-center">
                                <form>
                                    <button type="submit" formaction="${pageContext.request.contextPath}/admin/lich-trinh/${lichTrinh.maLichTrinh}/edit" class="btn-shadow btn btn-primary">Sửa</button>
                                </form>
                            </td>
                        </tr>
                    </c:forEach>
